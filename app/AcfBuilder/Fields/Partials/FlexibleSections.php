...
$builder
	->addFlexibleContent('flexible_sections', [
		...
		->addLayout(get_field_partial('Fields.Sections.FaqStandard'))
		->addLayout(get_field_partial('Fields.Sections.FaqWithCta'))
		->addLayout(get_field_partial('Fields.Sections.ImageLeftRight'))
		->addLayout(get_field_partial('Fields.Sections.Intro'))
		->addLayout(get_field_partial('Fields.Sections.FullWidthImage'))
		->addLayout(get_field_partial('Fields.Sections.PageCards'))
		->addLayout(get_field_partial('Fields.Sections.PageCardsOverlaid'))
		->addLayout(get_field_partial('Fields.Sections.LocationsTabbed'))
		->addLayout(get_field_partial('Fields.Sections.LogosStandard'))
		->addLayout(get_field_partial('Fields.Sections.LogosCarousel'))
		->addLayout(get_field_partial('Fields.Sections.ServiceTiles'))
		->addLayout(get_field_partial('Fields.Sections.ServiceTilesOverlaid'))
		->addLayout(get_field_partial('Fields.Sections.Team'))
		->addLayout(get_field_partial('Fields.Sections.TestimonialsSingle'))
		->addLayout(get_field_partial('Fields.Sections.TestimonialsDual'))
		->addLayout(get_field_partial('Fields.Sections.UspHorizontal'))
