...
collect(['setup', 'filters', 'Acf/Pages', 'AcfBuilder/Config', 'Wordpress/Admin', 'Wordpress/Acf', 'Wordpress/Fonts', 'Wordpress/GravityForms', 'Wordpress/IconPicker', 'Wordpress/PostTypes'])
    ->each(function ($file) {
